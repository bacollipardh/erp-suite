...
export const navSections: NavSection[] = [
    ...
    items: [
      {
        ...
        href: '/shitja',
        permission: [PERMISSIONS.customersRead, PERMISSIONS.salesInvoicesRead, PERMISSIONS.salesInvoicesManage, PERMISSIONS.salesReturnsRead, PERMISSIONS.reportsSales],
      },
    ...
    items: [
      {
        ...
        href: '/blerja',
        permission: [PERMISSIONS.suppliersRead, PERMISSIONS.purchaseInvoicesRead, PERMISSIONS.purchaseInvoicesManage],
      },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Kontrolli Mujor', href: '/financa/kontrolli-mujor', permission: PERMISSIONS.financialPeriodsRead },
      { label: 'Libri Kontabel', href: '/financa/libri-kontabel', permission: PERMISSIONS.accountingRead },
      { label: 'Kontot Kontabel', href: '/financa/libri-kontabel/kontot', permission: PERMISSIONS.accountingRead },
      { label: 'Journal Entries', href: '/financa/libri-kontabel/journal', permission: PERMISSIONS.accountingRead },
      { label: 'Journal Entry Manuale', href: '/financa/libri-kontabel/new', permission: PERMISSIONS.accountingManage },
      { label: 'Mbyllja Kontabel', href: '/financa/mbyllja-kontabel', permission: PERMISSIONS.accountingManage },
      { label: 'TVSH & Taksat', href: '/financa/tvsh', permission: PERMISSIONS.accountingRead },
      { label: 'Deklarata Mujore e TVSH-se', href: '/financa/deklarata-tvsh', permission: PERMISSIONS.accountingRead },
      { label: 'Pajtimi Bankar', href: '/financa/pajtimi-bankar', permission: PERMISSIONS.financeAccountsRead },
    ...
    items: [
      {
        ...
        href: '/stoku',
        permission: [PERMISSIONS.itemsRead, PERMISSIONS.warehousesRead, PERMISSIONS.stockRead, PERMISSIONS.stockAdjust],
      },
      ...
      { label: 'Rregullim Stoku', href: '/stock/operations/rregullim', permission: PERMISSIONS.stockAdjust },
      { label: 'Transfer Magazinash', href: '/stock/operations/transfer', permission: PERMISSIONS.stockTransfer },
      { label: 'Inventarizim', href: '/stock/operations/inventarizim', permission: PERMISSIONS.stockAdjust },
    ],
  },
  {
    title: 'WMS',
    ...
    items: [
      ...
      { label: 'Rezervimet WMS', href: '/wms/reservations', permission: PERMISSIONS.wmsRead },
      { label: 'Pranim Malli', href: '/wms/receiving', permission: PERMISSIONS.wmsReceive },
      { label: 'Putaway', href: '/wms/putaway', permission: PERMISSIONS.wmsMove },
      { label: 'Levizje Bin-to-Bin', href: '/wms/move', permission: PERMISSIONS.wmsMove },
      { label: 'Replenishment', href: '/wms/replenishment', permission: PERMISSIONS.wmsMove },
      { label: 'Inventarizim WMS', href: '/wms/counts', permission: PERMISSIONS.wmsCount },
      { label: 'Plan Cycle Count', href: '/wms/cycle-counts', permission: PERMISSIONS.wmsCount },
      { label: 'QC dhe Bllokim', href: '/wms/qc', permission: PERMISSIONS.wmsManage },
      { label: 'Skadencat', href: '/wms/expiry', permission: PERMISSIONS.wmsRead },
      { label: 'Picking Shitje', href: '/wms/picking', permission: PERMISSIONS.wmsPick },
      { label: 'Packing Shitje', href: '/wms/packing', permission: PERMISSIONS.wmsPick },
    ...
    items: [
      {
        ...
        href: '/raportet',
        permission: [PERMISSIONS.reportsSales, PERMISSIONS.reportsReceivables, PERMISSIONS.reportsPayables, PERMISSIONS.reportsAccounting, PERMISSIONS.stockRead],
      },
      { label: 'Raportet e Shitjes', href: '/raportet/shitje', permission: PERMISSIONS.reportsSales },
      { label: 'Raportet Financiare', href: '/raportet/financa', permission: [PERMISSIONS.reportsReceivables, PERMISSIONS.reportsPayables, PERMISSIONS.financeAccountsRead] },
      { label: 'Raporti i Arketimeve', href: '/raportet/financa/arketimet', permission: PERMISSIONS.reportsReceivables },
      { label: 'Raporti i Pagesave', href: '/raportet/financa/pagesat', permission: PERMISSIONS.reportsPayables },
      { label: 'Raporti i Pajtimit Bankar', href: '/raportet/financa/pajtimi-bankar', permission: PERMISSIONS.financeAccountsRead },
      { label: 'Raportet Kontabel', href: '/raportet/kontabiliteti', permission: PERMISSIONS.reportsAccounting },
      { label: 'Trial Balance', href: '/raportet/kontabiliteti/trial-balance', permission: PERMISSIONS.reportsAccounting },
      { label: 'Fitim-Humbje', href: '/raportet/kontabiliteti/fitim-humbje', permission: PERMISSIONS.reportsAccounting },
      { label: 'Bilanci', href: '/raportet/kontabiliteti/bilanci', permission: PERMISSIONS.reportsAccounting },
      { label: 'TVSH Ledger', href: '/raportet/kontabiliteti/tvsh-ledger', permission: PERMISSIONS.reportsAccounting },
  ...
  },
  {
    title: 'Administrim',
    iconPath:
      'M10.343 3.94c.09-.542.56-.94 1.11-.94h1.093c.55 0 1.02.398 1.11.94l.149.894c.07.424.384.764.78.93.398.164.855.142 1.205-.108l.737-.527a1.125 1.125 0 011.45.12l.773.774c.39.389.44 1.002.12 1.45l-.527.737c-.25.35-.272.806-.107 1.204.165.397.505.71.93.78l.893.15c.543.09.94.56.94 1.109v1.094c0 .55-.397 1.02-.94 1.11l-.893.149c-.425.07-.765.383-.93.78-.165.398-.143.854.107 1.204l.527.738c.32.447.269 1.06-.12 1.45l-.774.773a1.125 1.125 0 01-1.449.12l-.738-.527c-.35-.25-.806-.272-1.203-.107-.397.165-.71.505-.781.929l-.149.894c-.09.542-.56.94-1.11.94h-1.094c-.55 0-1.019-.398-1.11-.94l-.148-.894c-.071-.424-.384-.764-.781-.93-.398-.164-.854-.142-1.204.108l-.738.527c-.447.32-1.06.269-1.45-.12l-.773-.774a1.125 1.125 0 01-.12-1.45l.527-.737c.25-.35.273-.806.108-1.204-.165-.397-.505-.71-.93-.78l-.894-.15c-.542-.09-.94-.56-.94-1.109v-1.094c0-.55.398-1.02.94-1.11l.894-.149c.424-.07.765-.383.93-.78.165-.398.143-.854-.108-1.204l-.526-.738a1.125 1.125 0 01.12-1.45l.773-.773a1.125 1.125 0 011.45-.12l.737.527c.35.25.807.272 1.204.107.397-.165.71-.505.78-.929l.15-.894z M15 12a3 3 0 11-6 0 3 0 016 0z',
    defaultOpen: false,
    items: [
