          ...
          <div className="flex flex-col justify-between gap-5">
            ...
            <div className="grid gap-3 md:grid-cols-3">
              <Link href="/control-tower/exceptions" className="rounded-xl border bg-white p-4 shadow-sm hover:bg-slate-50">
                ...
                <div className="mt-1 text-sm font-semibold text-indigo-600">Go to Control Tower</div>
              </Link>
              <Link href="/statements/customers" className="rounded-xl border bg-white p-4 shadow-sm hover:bg-slate-50">
                <div className="text-xs text-slate-500">Receivables</div>
                <div className="mt-1 text-sm font-semibold text-indigo-600">Customer Statement</div>
              </Link>
              <Link href="/statements/suppliers" className="rounded-xl border bg-white p-4 shadow-sm hover:bg-slate-50">
                <div className="text-xs text-slate-500">Payables</div>
                <div className="mt-1 text-sm font-semibold text-indigo-600">Supplier Statement</div>
              </Link>
            </div>
